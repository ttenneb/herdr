...
`disposition: "cascade_close"` or `"promote_members"`; cascade close can return
`confirmation_required` when it would close a worktree group. Collection
responses include stable IDs, ordered members, archive/selection state,
