...
```bash
herdr worktree list [--repository ID | --workspace ID | --cwd PATH] [--json]
...
herdr collection close <collection_id> [--cascade-close|--promote-members] [--target-pane ID] [--focus-promoted]
```
