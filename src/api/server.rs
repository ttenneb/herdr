...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::WorkspaceReportResources(_) => "workspace.resources.report",
        Method::WorkspaceClose(_) => "workspace.close",
        Method::RepositoryList(_) => "repository.list",
        Method::RepositoryGet(_) => "repository.get",
        Method::RepositoryFocus(_) => "repository.focus",
        Method::RepositoryRename(_) => "repository.rename",
        Method::RepositoryMove(_) => "repository.move",
        Method::RepositoryClose(_) => "repository.close",
        Method::CheckoutOpen(_) => "checkout.open",
        Method::CheckoutFocus(_) => "checkout.focus",
        Method::CheckoutRename(_) => "checkout.rename",
        Method::CheckoutMove(_) => "checkout.move",
        Method::CheckoutClose(_) => "checkout.close",
        ...
        Method::CollectionAdd(_) => "collection.add",
        Method::CollectionMove(_) => "collection.move",
        Method::CollectionPromote(_) => "collection.promote",
        Method::CollectionSelect(_) => "collection.select",
        Method::CollectionReorder(_) => "collection.reorder",
        ...
        Method::DelegationDescendants(_) => "delegation.descendants",
        Method::DelegationReparent(_) => "delegation.reparent",
        Method::DelegationReorder(_) => "delegation.reorder",
